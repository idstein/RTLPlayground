...
- keepLINK KP-9000-9XHPML-X-EU / -AC (RTL8373 + RTL8224, HW V1.1, 8x 2.5GBit 802.3bt PoE+ + 1x 10G SFP+, managed; PoE handled by a Realtek RTL8238B PSE controller on the PoE daughter board (I2C 0x20/0x21); -EU and -AC differ only in bundled mains plug — *initial support, untested*)
